...
const Slider = React.forwardRef(function Slider(props, ref) {
  const {
    ...
    valueLabelFormat = Identity
        ...
        other = _objectWithoutPropertiesLoose(props, ["aria-label", "aria-labelledby", "aria-valuetext", "classes", "className", "color", "component", "defaultValue", "disabled", "getAriaLabel", "getAriaValueText", "marks", "max", "min", "name", "onChange", "onChangeCommitted", "onMouseDown", "orientation", "step", "ThumbComponent", "value", "ValueLabelComponent", "valueLabelDisplay", "valueLabelFormat"]);
  ...
  return React.createElement(Component, _extends({
    ref: handleRef,
    className: clsx(classes.root, classes[`color${capitalize(color)}`], className, disabled && classes.disabled, marks.length > 0 && marks.some(mark => mark.label) && classes.marked, {
    ...
    return React.createElement(ValueLabelComponent, {
      ...
      className: clsx(classes.thumb, classes[`thumbColor${capitalize(color)}`], active === index && classes.active, focusVisible === index && classes.focusVisible),
