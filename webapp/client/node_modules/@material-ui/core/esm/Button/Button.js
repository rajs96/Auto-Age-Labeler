...
var Button = React.forwardRef(function Button(props, ref) {
  ...
  return React.createElement(ButtonBase, _extends({
    className: clsx(classes.root, classes[variant], classes["".concat(variant).concat(color !== 'default' && color !== 'inherit' ? capitalize(color) : '')], className, size !== 'medium' && [classes["".concat(variant, "Size").concat(capitalize(size))], classes["size".concat(capitalize(size))]], disabled && classes.disabled, fullWidth && classes.fullWidth, {
