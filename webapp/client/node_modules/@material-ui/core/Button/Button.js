...
var Button = _react.default.forwardRef(function Button(props, ref) {
  var children = props.children,
      ...
      other = (0, _objectWithoutProperties2.default)(props, ["children", "classes", "className", "color", "component", "disabled", "disableFocusRipple", "endIcon", "focusVisibleClassName", "fullWidth", "size", "startIcon", "type", "variant"]);

  var startIcon = startIconProp && _react.default.createElement("span", {
    className: (0, _clsx.default)(classes.startIcon, classes["iconSize".concat((0, _helpers.capitalize)(size))])
  }, startIconProp);

  var endIcon = endIconProp && _react.default.createElement("span", {
    className: (0, _clsx.default)(classes.endIcon, classes["iconSize".concat((0, _helpers.capitalize)(size))])
  }, endIconProp);

  return _react.default.createElement(_ButtonBase.default, (0, _extends2.default)({
    className: (0, _clsx.default)(classes.root, classes[variant], classes["".concat(variant).concat(color !== 'default' && color !== 'inherit' ? (0, _helpers.capitalize)(color) : '')], className, size !== 'medium' && [classes["".concat(variant, "Size").concat((0, _helpers.capitalize)(size))], classes["size".concat((0, _helpers.capitalize)(size))]], disabled && classes.disabled, fullWidth && classes.fullWidth, {
