...
var Tooltip = _react.default.forwardRef(function Tooltip(props, ref) {
  ...
  var handleUseRef = (0, _reactHelpers.useForkRef)(setChildNode, ref);
  var handleFocusRef = (0, _reactHelpers.useForkRef)(focusVisibleRef, handleUseRef); // can be removed once we drop support for non ref forwarding class components

  var handleOwnRef = _react.default.useCallback(function (instance) {
    // #StrictMode ready
    (0, _reactHelpers.setRef)(handleFocusRef, _reactDom.default.findDOMNode(instance));
  }, [handleFocusRef]);
